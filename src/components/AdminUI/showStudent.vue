      ...
      <div class="card-body">
        ...
        <b-list-group>
          <b-list-group-item v-for="st in student" :key="st.Id">
            <strong> First Name </strong>: &nbsp; {{ st.Fname }} &nbsp; &nbsp;
            <strong> Last Name : &nbsp; </strong> {{ st.Lname }} &nbsp;
            <b> reg Number </b>: {{ st.regNum }}
            <p>
              <span @click="deleteStu(st.Id)">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <b-form>
              ...
              <b-form-input type="number" class="mb-3" v-model="edit.regNumber">
              </b-form-input>
...
export default {
  ...
  methods: {
    update(e) {
      ...
      let Id = this.edit.Id;
      axios
        .put(`http://localhost:3000/api/student/${Id}`, this.edit)
        .then((res) => {
          if (res.data === 200) {

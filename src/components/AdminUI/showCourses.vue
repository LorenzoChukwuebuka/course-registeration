        ...
        <h5 class="card-title"> Courses </h5>
           <b-list-group>
                <b-list-group-item v-for="cos in course" :key="cos.cid">
                    <strong>Course Code</strong>: &nbsp; {{cos.course_code}} &nbsp; &nbsp; <strong> Course Title : &nbsp; </strong> {{cos.course_title}} &nbsp; <b> level </b>: {{cos.levels}} 
                    <p>  <span @click="deleteCourse(cos.cid)"> <b-button class="bg-danger"> <b-icon icon="trash-fill" aria-hidden="true">  </b-icon> </b-button> </span>
                     &nbsp;
                 
                   <span @click="startEdit(cos,cos.cid)"> <b-button class="bg-primary" v-b-modal.modal-1> <b-icon icon ="pencil-fill"> </b-icon> </b-button>  </span> </p>
            ...
            <div class="card-body">
                     <b-form>
                        <label for="input-none"> Course Code</label>
                         <b-form-input class="mb-3" v-model="edit.courseCode"> </b-form-input>
                         <label for="input-none"> Course title</label>
                         <b-form-input class="mb-3" v-model="edit.CourseTitle"> </b-form-input>
                         <div class='mb-3'>

...
<div>
 <Nav />
      ...
      <div class="card  mx-auto  flex mt-5 shadow" style="width:40%;background-color:lilac;">
       <div class="card-body">
		  ...
		  <div v-if="errors.length"  class="alert alert-danger" role="alert">
            ...
            <form>
					<div class="form-group">
						...
						<input type="text" class="form-control" id="exampleInputEmail1" v-model="form.username" >
					...
					<button type="submit" @click="submit" class="btn btn-primary mt-3">Submit</button>
            </form>
